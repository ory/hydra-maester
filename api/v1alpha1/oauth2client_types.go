...
// +kubebuilder:validation:Enum=id_token;code;token;code token;token code;code id_token;id_token code;id_token token;token id_token;code id_token token;id_token token code;token code id_token;code token id_token
