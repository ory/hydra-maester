...
func (in *ClientSecretSource) DeepCopyInto(out *ClientSecretSource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientSecretSource.
func (in *ClientSecretSource) DeepCopy() *ClientSecretSource {
	if in == nil {
		return nil
	}
	out := new(ClientSecretSource)
	in.DeepCopyInto(out)
	return out
}
